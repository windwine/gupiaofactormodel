---
title: "Data Check ver4 with all 5 factor data last biz day +ML"
output:
  html_document:
    df_print: paged
---
...
check<-final %>% 
  filter(SecurityID==100892)
print(check)
#对于AFL grossmargin 一直NA? 所以我只能fill 0?这样好像有点不合适， 有很多都是有na不能直接dropna？？
